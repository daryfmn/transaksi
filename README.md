...
## 🗒️ Assigment
Finish This Code By Implementing API, CRUD METHODS, Swagger Documentation, Authentication Token, And Actions (MAIN)
...
Actions
- Run without using docker or test with mysql ✅
